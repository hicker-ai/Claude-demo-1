...
func (_c *GroupCreate) SetParentID(v uuid.UUID) *GroupCreate {
	_c.mutation.SetParentID(v)
	return _c
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (_c *GroupCreate) SetNillableParentID(v *uuid.UUID) *GroupCreate {
	if v != nil {
		_c.SetParentID(*v)
	}
	return _c
...
func (_c *GroupCreate) AddChildIDs(ids ...uuid.UUID) *GroupCreate {
